...
// Modified from https://github.com/machinebox/graphql
import (
	"bytes"
	"context"
	"encoding/json"
...
func toError(e graphErr) GraphqlError {
	if len(e.Details.Errors) > 0 {
		err := e.Details.Errors[0]
		return GraphqlError{Message: err.Message, Type: err.Type}
	}
